...
export const CREATE_TABLE_STATEMENTS = [
  ...
  `CREATE TABLE IF NOT EXISTS licenses (
    ...
    setup_box_key TEXT,
    product_license_key TEXT,
    product_key_issued_at TIMESTAMPTZ,
    object_api_secret TEXT,
  ...
  `ALTER TABLE licenses ADD COLUMN IF NOT EXISTS product_license_key TEXT`,
  `ALTER TABLE licenses ADD COLUMN IF NOT EXISTS product_key_issued_at TIMESTAMPTZ`,
  `ALTER TABLE licenses ADD COLUMN IF NOT EXISTS object_api_secret TEXT`,
